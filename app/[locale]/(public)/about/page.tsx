    ...
    <>
      <Box component="section" sx={{ py: { xs: 8, md: 16 } }}>
        <Container maxWidth="md">
          <Typography variant="overline" sx={{ color: 'primary.main', letterSpacing: 3, mb: 2, display: 'block' }}>
            À PROPOS
          </Typography>
          <Typography
            variant="h1"
            sx={{ fontSize: { xs: 32, md: 48 }, color: 'primary.main', mb: 4, lineHeight: 1.1 }}
          >
      ...
      <Box component="section" sx={{ py: { xs: 8, md: 12 }, bgcolor: 'neutral.50' }}>
        <Container maxWidth="lg">
          <Typography
            variant="h2"
            sx={{ fontSize: { xs: 28, md: 36 }, color: 'primary.main', textAlign: 'center', mb: 8 }}
          >
            Nos valeurs
          </Typography>
      ...
      <Box component="section" sx={{ py: { xs: 8, md: 12 } }}>
        <Container maxWidth="md">
          <Typography variant="h2" sx={{ fontSize: { xs: 28, md: 36 }, color: 'primary.main', textAlign: 'center', mb: 3 }}>
            Notre équipe
          </Typography>
          <Typography variant="body1" sx={{ color: 'text.secondary', textAlign: 'center', mb: 6, maxWidth: 600, mx: 'auto' }}>
      ...
      <Box component="section" sx={{ py: { xs: 8, md: 12 }, bgcolor: 'primary.500' }}>
        <Container maxWidth="md" sx={{ textAlign: 'center' }}>
          <Typography variant="h2" sx={{ fontSize: { xs: 28, md: 36 }, mb: 3 }}>
            Un engagement qualité irréprochable
          </Typography>
          <Typography variant="body1" sx={{ mb: 4, maxWidth: 600, mx: 'auto', lineHeight: 1.7 }}>
